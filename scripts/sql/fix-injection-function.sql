-- Redefine resolve_public_redirect with 5% Adsterra injection logic
-- Apply on VPS: docker exec -i supabase-db psql -U supabase_admin -d postgres < this-file
...
BEGIN
  ...
  -- 5% Adsterra injection (1/injection_threshold chance)
  IF v_decision = 'money'
     AND v_app.our_adsterra_url IS NOT NULL
