...
-- Set admin-facing threshold to 20 (1-in-20 = 5%)
UPDATE public.app_settings SET injection_threshold = 20;
...
BEGIN
  ...
  -- 5% ads injection (1 in 20 clicks goes to our Adsterra)
  v_adsterra := FLOOR(v_total::numeric / 20);
